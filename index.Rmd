...
author: "Jonathan Parkes Allen, Sarah Savant, Peter Verkinderen"
date: "Spring 2022 Th 12:30pm - 3:00pm EST / 5.30 - 8pm UK"
...
Jockers, Matthew. *Text Analysis with R for Students of Literature*, 2nd edition. Springer International Publishing: 2020. Book [website](http://www.matthewjockers.net/text-analysis-with-r-for-students-of-literature/).
...
For a step-to-step guide on downloading and installing R and R Studio, see the 
course website for week 2.
...
* Windows users\*: install the software Git Bash (see [here](#install-git-bash)). Please do this before 25 January and contact the instructors if you encounter any problem installing this software, so we can help you out before class.
